...
class ProductHttpService {
    ...
    update(id, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield axios_1.default.put(`${this.url}/${id}`, changes);
            return data;
        });
    }
    create(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield axios_1.default.post(this.url, dto);
            return data;
        });
    }
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data } = yield axios_1.default.get(`${this.url}/${id}`);
            return data;
        });
    }
}
